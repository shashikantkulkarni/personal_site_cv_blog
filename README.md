...
<h1 align="center">
  Gatsby's ShashikantKulkarni Portfolio template using <a href='https://ant.design/' target='_blank'>ant-design</a>
</h1>
...
1.  **Setup the project by.**
    ...
    git clone https://github.com/shashikantkulkarni/personal_site_cv_blog.git
    cd personal_site_cv_blog
    npm install
    ```
